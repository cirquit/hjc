...
class Scene extends Object{
	...
	public int init( int f) {
		...
		sphereZ = sphereCount;
		sphereR = sphereCount;
		sphereRed = sphereCount;
		sphereGreen = sphereCount;
		sphereBlue = sphereCount;
		sphereRefl = sphereCount;
		sphereX[0] = f  *  ( 0  -  7 );
		sphereY[0] = 0;
		sphereZ[0] = 0;
		sphereR[0] = f  *  11;
...
b = 2  *  ( this.mul( r.getDir(  ).getX(  ),( r.getBase(  ).getX(  )  -  scene.getSphereX( i ) ) )  +  this.mul( r.getDir(  ).getY(  ),( r.getBase(  ).getY(  )  -  scene.getSphereY( i ) ) )  +  this.mul( r.getDir(  ).getZ(  ),( r.getBase(  ).getZ(  )  -  scene.getSphereZ( i ) ) ) );
c = this.mul( ( r.getBase(  ).getX(  )  -  scene.getSphereX( i ) ),( r.getBase(  ).getX(  )  -  scene.getSphereX( i ) ) )  +  this.mul( r.getBase(  ).getY(  )  -  scene.getSphereY( i ),r.getBase(  ).getY(  )  -  scene.getSphereY( i ) )  +  this.mul( r.getBase(  ).getZ(  )  -  scene.getSphereZ( i ),r.getBase(  ).getZ(  )  -  scene.getSphereZ( i ) )  -  this.mul( scene.getSphereR( i ),scene.getSphereR( i ) );
...
d = intersection.getBase(  ).setXYZ( ray.getBase(  ).getX(  )  +  this.mul( intersectionTime,ray.getDir(  ).getX(  ) ),ray.getBase(  ).getY(  )  +  this.mul( intersectionTime,ray.getDir(  ).getY(  ) ),ray.getBase(  ).getZ(  )  +  this.mul( intersectionTime,ray.getDir(  ).getZ(  ) ) );
d = intersection.getDir(  ).set( ray.getDir(  ) );
d = rayToViewer.getBase(  ).set( intersection.getBase(  ) );
d = rayToViewer.getDir(  ).setXYZ( ray.getBase(  ).getX(  )  -  intersection.getBase(  ).getX(  ),ray.getBase(  ).getY(  )  -  intersection.getBase(  ).getY(  ),ray.getBase(  ).getZ(  )  -  intersection.getBase(  ).getZ(  ) );
