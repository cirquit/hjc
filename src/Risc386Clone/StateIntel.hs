...
module Risc386Clone.StateIntel where
...
import Risc386Clone.Util -- fmap2
import Risc386Clone.GenSym hiding (St,initSt)
import Risc386Clone.Frame -- (wordSize,Acc(..))
import Risc386Clone.Intel as Intel
